namespace Liga_Futebol.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Liga_Futebol.BancoDados.LigaFutebolContext>
    {
        ...
        protected override void Seed(Liga_Futebol.BancoDados.LigaFutebolContext context)
        {
            ...
            var times = new List<Time>
            {
                ...
                new Time { Nome = "Flamengo 1981", Status = true, CorUniformesPrimaria = "Vermelho e Preto", CorUniformesSecundaria = "Branco", DataFundacao = 1895, Cidade = "Rio de Janeiro", Estado = "RJ", EstadioTime = "Maracanã", CapacidadeEstagio = 78838 },
            };
            ...
            var ligas = new List<Liga>
            {
                ...
                new Liga { Nome = "Liga Tabajara Futebol", Status = true, DataInicio = DateTime.Now, DataFim = DateTime.Now.AddMonths(6) },
            };
            ...
            if (santos1962 != null)
            {
                ...
                var jogadores = new List<Jogador>
                {
                    ...
                    new Jogador { Nome = "Gabriel Menino", DataNascimento = new DateTime(2000, 5, 15), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 29, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = santos1962.Id },
                    new Jogador { Nome = "Rafael Santos", DataNascimento = new DateTime(1998, 3, 10), Nacionalidade = "Brasil", Posicao = Posicao.Goleiro, NumCamisa = 30, Altura = 1.88m, Peso = 84m, PePreferido = PePreferido.Direito, TimeId = santos1962.Id },
                    new Jogador { Nome = "Felipe Jonatan", DataNascimento = new DateTime(1998, 5, 14), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 31, Altura = 1.75m, Peso = 70m, PePreferido = PePreferido.Direito, TimeId = santos1962.Id },
                };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
            ...
            if (palmeiras2020 != null)
            {
                ...
                var jogadores = new List<Jogador>
                {
                    ...
                    new Jogador { Nome = "Lucas", DataNascimento = new DateTime(1994, 8, 20), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 22, Altura = 1.81m, Peso = 77m, PePreferido = PePreferido.Direito, TimeId = palmeiras2020.Id },
                    new Jogador { Nome = "Rafael", DataNascimento = new DateTime(1993, 9, 25), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 26, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = palmeiras2020.Id },
                    new Jogador { Nome = "Thiago", DataNascimento = new DateTime(1992, 4, 18), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 34, Altura = 1.84m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = palmeiras2020.Id },
                    new Jogador { Nome = "Samuel", DataNascimento = new DateTime(1991, 3, 12), Nacionalidade = "Brasil", Posicao = Posicao.Defensor, NumCamisa = 35, Altura = 1.85m, Peso = 82m, PePreferido = PePreferido.Direito, TimeId = palmeiras2020.Id },
                    new Jogador { Nome = "Gabriel Silva", DataNascimento = new DateTime(2000, 2, 8), Nacionalidade = "Brasil", Posicao = Posicao.Goleiro, NumCamisa = 36, Altura = 1.87m, Peso = 84m, PePreferido = PePreferido.Direito, TimeId = palmeiras2020.Id },
                };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Gabriel", DataNascimento = new DateTime(1994, 5, 5), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 33, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
        new Jogador { Nome = "Fagner", DataNascimento = new DateTime(1989, 3, 11), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 23, Altura = 1.78m, Peso = 76m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
        new Jogador { Nome = "Rodrigo", DataNascimento = new DateTime(1990, 2, 20), Nacionalidade = "Brasil", Posicao = Posicao.Goleiro, NumCamisa = 29, Altura = 1.87m, Peso = 84m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
        new Jogador { Nome = "Matheus Vital", DataNascimento = new DateTime(1999, 1, 12), Nacionalidade = "Brasil", Posicao = Posicao.Meia, NumCamisa = 30, Altura = 1.77m, Peso = 74m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
        new Jogador { Nome = "Léo Santos", DataNascimento = new DateTime(1999, 2, 22), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 35, Altura = 1.84m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
        new Jogador { Nome = "Roni", DataNascimento = new DateTime(2000, 3, 15), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 37, Altura = 1.73m, Peso = 70m, PePreferido = PePreferido.Direito, TimeId = corinthians2012.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Ricardo Oliveira", DataNascimento = new DateTime(1980, 5, 6), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 9, Altura = 1.84m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
        new Jogador { Nome = "Thiago Silva", DataNascimento = new DateTime(1984, 9, 22), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 3, Altura = 1.83m, Peso = 78m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
        new Jogador { Nome = "Aislan", DataNascimento = new DateTime(1988, 1, 1), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 2, Altura = 1.82m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
        new Jogador { Nome = "Rodrigo Caio", DataNascimento = new DateTime(1993, 8, 17), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 4, Altura = 1.85m, Peso = 82m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
        new Jogador { Nome = "Lucas", DataNascimento = new DateTime(1992, 1, 13), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 7, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
        new Jogador { Nome = "Wellington", DataNascimento = new DateTime(1990, 1, 1), Nacionalidade = "Brasil", Posicao = Posicao.Volante, NumCamisa = 17, Altura = 1.78m, Peso = 74m, PePreferido = PePreferido.Direito, TimeId = saoPaulo2005.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Ricardo Rocha", DataNascimento = new DateTime(1974, 1, 1), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 31, Altura = 1.84m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = cruzeiro2003.Id },
        new Jogador { Nome = "Marcelinho Paraíba", DataNascimento = new DateTime(1976, 5, 17), Nacionalidade = "Brasil", Posicao = Posicao.MeioCampo, NumCamisa = 32, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = cruzeiro2003.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Felipe Silva", DataNascimento = new DateTime(1990, 3, 15), Nacionalidade = "Brasil", Posicao = Posicao.Lateral, NumCamisa = 36, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = gremio1995.Id },
        new Jogador { Nome = "Gabriel Santos", DataNascimento = new DateTime(1997, 11, 28), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 37, Altura = 1.82m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = gremio1995.Id },
        new Jogador { Nome = "Matheus Lima", DataNascimento = new DateTime(1994, 4, 20), Nacionalidade = "Brasil", Posicao = Posicao.Goleiro, NumCamisa = 38, Altura = 1.85m, Peso = 82m, PePreferido = PePreferido.Direito, TimeId = gremio1995.Id },
        new Jogador { Nome = "Rafael Santos", DataNascimento = new DateTime(1991, 10, 10), Nacionalidade = "Brasil", Posicao = Posicao.Goleiro, NumCamisa = 39, Altura = 1.88m, Peso = 84m, PePreferido = PePreferido.Direito, TimeId = gremio1995.Id },
        new Jogador { Nome = "Anderson Silva", DataNascimento = new DateTime(1993, 9, 5), Nacionalidade = "Brasil", Posicao = Posicao.Zagueiro, NumCamisa = 40, Altura = 1.90m, Peso = 88m, PePreferido = PePreferido.Direito, TimeId = gremio1995.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Leandro Damião", DataNascimento = new DateTime(1989, 7, 22), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 31, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = internacional2006.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Andriy Shevchenko", Posicao = Posicao.Atacante, DataNascimento = new DateTime(1976, 9, 29), Nacionalidade = "Ucrânia", NumCamisa = 7, Altura = 1.83m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Dino Baggio", Posicao = Posicao.Volante, DataNascimento = new DateTime(1967, 1, 24), Nacionalidade = "Itália", NumCamisa = 8, Altura = 1.80m, Peso = 78m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Alberto Gilardino", Posicao = Posicao.Atacante, DataNascimento = new DateTime(1982, 7, 5), Nacionalidade = "Itália", NumCamisa = 11, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Massimo Ambrosini", Posicao = Posicao.Volante, DataNascimento = new DateTime(1977, 5, 29), Nacionalidade = "Itália", NumCamisa = 23, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Gennaro Gattuso", Posicao = Posicao.Volante, DataNascimento = new DateTime(1978, 1, 9), Nacionalidade = "Itália", NumCamisa = 8, Altura = 1.80m, Peso = 78m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Clarence Seedorf", Posicao = Posicao.Volante, DataNascimento = new DateTime(1976, 4, 1), Nacionalidade = "Países Baixos", NumCamisa = 10, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Filippo Inzaghi", Posicao = Posicao.Atacante, DataNascimento = new DateTime(1973, 8, 9), Nacionalidade = "Itália", NumCamisa = 9, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Alessandro Nesta", Posicao = Posicao.Zagueiro, DataNascimento = new DateTime(1976, 3, 19), Nacionalidade = "Itália", NumCamisa = 13, Altura = 1.82m, Peso = 79m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Massimo Oddo", Posicao = Posicao.Lateral, DataNascimento = new DateTime(1976, 2, 14), Nacionalidade = "Itália", NumCamisa = 2, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Alberto Aquilani", Posicao = Posicao.Volante, DataNascimento = new DateTime(1984, 7, 7), Nacionalidade = "Itália", NumCamisa = 16, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
        new Jogador { Nome = "Andrea Pirlo", Posicao = Posicao.Volante, DataNascimento = new DateTime(1979, 5, 19), Nacionalidade = "Itália", NumCamisa = 21, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = milan1989.Id },
    };
                ...
                var jogadores = new List<Jogador>
    {
       // Goleiros
        ...
        new Jogador { Nome = "Kieran Richardson", DataNascimento = new DateTime(1984, 10, 21), Nacionalidade = "Inglaterra", Posicao = Posicao.Lateral, NumCamisa = 29, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Michael Clegg", DataNascimento = new DateTime(1974, 1, 1), Nacionalidade = "Inglaterra", Posicao = Posicao.Zagueiro, NumCamisa = 30, Altura = 1.82m, Peso = 76m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Danny Pugh", DataNascimento = new DateTime(1981, 4, 23), Nacionalidade = "Inglaterra", Posicao = Posicao.Volante, NumCamisa = 31, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "David Healy", DataNascimento = new DateTime(1979, 5, 6), Nacionalidade = "Irlanda do Norte", Posicao = Posicao.Atacante, NumCamisa = 32, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Michael Owen", DataNascimento = new DateTime(1979, 12, 14), Nacionalidade = "Inglaterra", Posicao = Posicao.Atacante, NumCamisa = 33, Altura = 1.75m, Peso = 70m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Darren Fletcher", DataNascimento = new DateTime(1984, 2, 1), Nacionalidade = "Escócia", Posicao = Posicao.Volante, NumCamisa = 34, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "John O'Shea", DataNascimento = new DateTime(1981, 4, 30), Nacionalidade = "Irlanda", Posicao = Posicao.Lateral, NumCamisa = 35, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Gary Walsh", DataNascimento = new DateTime(1970, 1, 1), Nacionalidade = "Inglaterra", Posicao = Posicao.Goleiro, NumCamisa = 36, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Ben Foster", DataNascimento = new DateTime(1983, 4, 3), Nacionalidade = "Inglaterra", Posicao = Posicao.Goleiro, NumCamisa = 37, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Kieran Richardson", DataNascimento = new DateTime(1984, 10, 21), Nacionalidade = "Inglaterra", Posicao = Posicao.Lateral, NumCamisa = 38, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Danny Simpson", DataNascimento = new DateTime(1986, 1, 4), Nacionalidade = "Inglaterra", Posicao = Posicao.Lateral, NumCamisa = 39, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
        new Jogador { Nome = "Chris Eagles", DataNascimento = new DateTime(1985, 11, 19), Nacionalidade = "Inglaterra", Posicao = Posicao.MeioCampo, NumCamisa = 40, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = manchester1999.Id },
    };
                // Adiciona no banco
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Bobby Duncan", DataNascimento = new DateTime(2001, 6, 26), Nacionalidade = "Inglaterra", Posicao = Posicao.Atacante, NumCamisa = 50, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = liverpool2019.Id },
        new Jogador { Nome = "Paul Glatzel", DataNascimento = new DateTime(2001, 9, 8), Nacionalidade = "Inglaterra", Posicao = Posicao.Atacante, NumCamisa = 52, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = liverpool2019.Id },
        new Jogador { Nome = "Leighton Clarkson", DataNascimento = new DateTime(2001, 10, 14), Nacionalidade = "Inglaterra", Posicao = Posicao.Volante, NumCamisa = 53, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = liverpool2019.Id },
        new Jogador { Nome = "Jake Cain", DataNascimento = new DateTime(2002, 1, 1), Nacionalidade = "Inglaterra", Posicao = Posicao.Volante, NumCamisa = 54, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = liverpool2019.Id },
        new Jogador { Nome = "Neco Williams", DataNascimento = new DateTime(2001, 4, 13), Nacionalidade = "País de Gales", Posicao = Posicao.Lateral, NumCamisa = 55, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = liverpool2019.Id },
    };
                ...
                var jogadores = new List<Jogador>
    {
        ...
        new Jogador { Nome = "Alexander Nübel", DataNascimento = new DateTime(1996, 9, 30), Nacionalidade = "Alemanha", Posicao = Posicao.Goleiro, NumCamisa = 35, Altura = 1.90m, Peso = 85m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
        new Jogador { Nome = "Leroy Sané", DataNascimento = new DateTime(1996, 1, 11), Nacionalidade = "Alemanha", Posicao = Posicao.Atacante, NumCamisa = 10, Altura = 1.83m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
        new Jogador { Nome = "Tanguy Kouassi", DataNascimento = new DateTime(2002, 6, 1), Nacionalidade = "França", Posicao = Posicao.Zagueiro, NumCamisa = 44, Altura = 1.85m, Peso = 80m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
        new Jogador { Nome = "Marc Roca", DataNascimento = new DateTime(1996, 11, 26), Nacionalidade = "Espanha", Posicao = Posicao.Volante, NumCamisa = 22, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
        new Jogador { Nome = "Bouna Sarr", DataNascimento = new DateTime(1992, 1, 31), Nacionalidade = "França", Posicao = Posicao.Lateral, NumCamisa = 20, Altura = 1.80m, Peso = 75m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
        new Jogador { Nome = "Douglas Costa", DataNascimento = new DateTime(1990, 9, 14), Nacionalidade = "Brasil", Posicao = Posicao.Atacante, NumCamisa = 11, Altura = 1.74m, Peso = 70m, PePreferido = PePreferido.Direito, TimeId = bayern2020.Id },
    };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
    ...
    new Jogador { Nome = "Wim van Hanegem", Posicao = Posicao.Volante, PePreferido = PePreferido.Direito, NumCamisa = 31, DataNascimento = new DateTime(1944, 2, 20), Nacionalidade = "Holanda", Altura = 1.80m, Peso = 75m, TimeId = ajax1971.Id },
    new Jogador { Nome = "Kees Kist", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 32, DataNascimento = new DateTime(1951, 4, 2), Nacionalidade = "Holanda", Altura = 1.82m, Peso = 78m, TimeId = ajax1971.Id },
};
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
    ...
    new Jogador { Nome = "Pablo Ledesma", Posicao = Posicao.Volante, PePreferido = PePreferido.Direito, NumCamisa = 31, DataNascimento = new DateTime(1984, 4, 24), Nacionalidade = "Argentina", Altura = 1.76m, Peso = 72m, TimeId = boca2000.Id },
    new Jogador { Nome = "Cristian González", Posicao = Posicao.Lateral, PePreferido = PePreferido.Direito, NumCamisa = 33, DataNascimento = new DateTime(1978, 1, 1), Nacionalidade = "Argentina", Altura = 1.80m, Peso = 75m, TimeId = boca2000.Id },
    new Jogador { Nome = "Diego Ceballos", Posicao = Posicao.Goleiro, PePreferido = PePreferido.Direito, NumCamisa = 34, DataNascimento = new DateTime(1978, 4, 1), Nacionalidade = "Argentina", Altura = 1.85m, Peso = 82m, TimeId = boca2000.Id },
    new Jogador { Nome = "Pablo Mouche", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 35, DataNascimento = new DateTime(1988, 1, 5), Nacionalidade = "Argentina", Altura = 1.75m, Peso = 70m, TimeId = boca2000.Id },
    new Jogador { Nome = "Nicolás Lodeiro", Posicao = Posicao.Meia, PePreferido = PePreferido.Direito, NumCamisa = 36, DataNascimento = new DateTime(1989, 3, 15), Nacionalidade = "Uruguai", Altura = 1.73m, Peso = 70m, TimeId = boca2000.Id },
    new Jogador { Nome = "Fernando Gago", Posicao = Posicao.Volante, PePreferido = PePreferido.Direito, NumCamisa = 37, DataNascimento = new DateTime(1986, 4, 10), Nacionalidade = "Argentina", Altura = 1.76m, Peso = 72m, TimeId = boca2000.Id },
};
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
    ...
    new Jogador { Nome = "Jorge González", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 31, DataNascimento = new DateTime(1938, 1, 15), Nacionalidade = "Uruguai", Altura = 1.80m, Peso = 78m, TimeId = penarol1960.Id },
    new Jogador { Nome = "Héctor Scarone", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 32, DataNascimento = new DateTime(1939, 2, 20), Nacionalidade = "Uruguai", Altura = 1.81m, Peso = 80m, TimeId = penarol1960.Id },
    new Jogador { Nome = "Pedro Virgilio Rocha", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 33, DataNascimento = new DateTime(1940, 3, 28), Nacionalidade = "Uruguai", Altura = 1.82m, Peso = 82m, TimeId = penarol1960.Id },
};
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
            ...
            if (flamengo1981 != null)
            {
                            ...
                            var jogadores = new List<Jogador>
                {
                    ...
                    new Jogador { Nome = "Ricardo Rocha", Posicao = Posicao.Zagueiro, PePreferido = PePreferido.Direito, NumCamisa = 23, DataNascimento = new DateTime(1966, 12, 29), Nacionalidade = "Brasil", Altura = 1.84m, Peso = 82m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Bebeto", Posicao = Posicao.Atacante, PePreferido = PePreferido.Direito, NumCamisa = 24, DataNascimento = new DateTime(1964, 2, 16), Nacionalidade = "Brasil", Altura = 1.79m, Peso = 78m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Ailton Lira", Posicao = Posicao.MeioCampo, PePreferido = PePreferido.Direito, NumCamisa = 25, DataNascimento = new DateTime(1957, 10, 23), Nacionalidade = "Brasil", Altura = 1.74m, Peso = 73m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Jorginho", Posicao = Posicao.Lateral, PePreferido = PePreferido.Direito, NumCamisa = 26, DataNascimento = new DateTime(1964, 12, 27), Nacionalidade = "Brasil", Altura = 1.73m, Peso = 71m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Toninho", Posicao = Posicao.MeioCampo, PePreferido = PePreferido.Direito, NumCamisa = 27, DataNascimento = new DateTime(1959, 7, 2), Nacionalidade = "Brasil", Altura = 1.75m, Peso = 74m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Marcio Nascimento", Posicao = Posicao.Goleiro, PePreferido = PePreferido.Direito, NumCamisa = 28, DataNascimento = new DateTime(1961, 3, 15), Nacionalidade = "Brasil", Altura = 1.87m, Peso = 80m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Luiz Carlos", Posicao = Posicao.Zagueiro, PePreferido = PePreferido.Direito, NumCamisa = 29, DataNascimento = new DateTime(1960, 4, 15), Nacionalidade = "Brasil", Altura = 1.82m, Peso = 79m, TimeId = flamengo1981.Id },
                    new Jogador { Nome = "Gilmar", Posicao = Posicao.Goleiro, PePreferido = PePreferido.Direito, NumCamisa = 30, DataNascimento = new DateTime(1960, 5, 20), Nacionalidade = "Brasil", Altura = 1.85m, Peso = 81m, TimeId = flamengo1981.Id },
                };
                jogadores.ForEach(j => context.Jogadores.AddOrUpdate(p => p.Nome, j));
                context.SaveChanges();
            }
